...
1. **Derive the intended behavior independently** of the code: from NatSpec/docs, the spec/ticket, prior audit findings, type/unit constraints, and domain invariants. Write the expected value/property from intent — do NOT read it off the code's current output.
